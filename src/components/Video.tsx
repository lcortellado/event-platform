       ...
       <div className="flex-1">
        ...
        <div className="p-8 max-w-[1100px] mx-auto">
         <div className="flex items-start gap-16">
          <div className="flex-1">
            <h1 className="text-2xl font-bold">Aula 01 - Abierta el Ignite Lab</h1>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              className="h-16 w-16 rounded-full border-2 border-blue-500"
               src="https://avatars.githubusercontent.com/u/9040303?v=4"
                alt="" 
                />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Luis Carlos Ortellado</strong>
                <span className="text-gray-200 text-sm block">@ Developer</span>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            <a href="" className="p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-gray-700 transition-colors">
              <DiscordLogo size={24} />
         ...
         <div className="gap-8 mt-20 grid grid-cols-2">
          <a href="" className="bg-gray-700 rounded averflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
