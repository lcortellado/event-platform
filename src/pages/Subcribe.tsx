            ...
            <div className='w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto'>
               <div className='max-w-[640px]'>
                 ...
                 <h1 className='mt-8 text-[2.5rem] leading-tight'>
                    Constuya una <strong className='text-blue-500'>aplicacion completa</strong> , de cero, con <strong className='text-blue-500'>React JS</strong> 
                 </h1>
              ...
              <strong className='text-2xl mb-6 block'>Inscríbase gratuitamente</strong>
